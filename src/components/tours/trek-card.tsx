...
import { Star, MapPin, Clock, Mountain, Users } from "lucide-react"
...
export function TrekCard({ trek }: { trek: Tour }) {
  ...
  return (
    <Link to={ROUTES.TREKS + `/${trek.id}`} className="group block overflow-hidden rounded-xl border border-border bg-card transition-all duration-300 hover:shadow-lg hover:border-primary/20">
