...
const fields: CrudField[] = [
  ...
  { name: 'minStartDate', label: 'Min Start Date', type: 'date', required: true },
  { name: 'maxEndDate', label: 'Max End Date', type: 'date', required: true },
    ...
    <CrudPage
      ...
      onCreate={async (payload) => {
        await adminApi.tours.create({
          ...
          minStartDate: String(payload.minStartDate || ''),
          maxEndDate: String(payload.maxEndDate || ''),
