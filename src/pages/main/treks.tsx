  ...
  return (
    <div className="min-h-screen bg-background pt-32 pb-12">
      <div className="mx-auto max-w-7xl px-6">
        {/* Header */}
        <div className="mb-12">
          <Badge variant="outline" className="mb-4">Adventure Collection</Badge>
          ...
          <p className="mt-4 text-sm text-muted-foreground">{trekkingTours.length} treks ready to explore</p>
        </div>
