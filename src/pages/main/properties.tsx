    ...
    <div className="bg-background">
      ...
      <div className="bg-secondary py-16">
        <div className="mx-auto max-w-7xl px-6">
          <Badge variant="outline" className="mb-4 bg-background/70">Stay Collection</Badge>
          ...
          <p className="mt-4 text-sm text-muted-foreground">{filtered.length} stays currently match your view</p>
        </div>
      </div>
